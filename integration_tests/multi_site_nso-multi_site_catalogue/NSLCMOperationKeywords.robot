...
POST New nsInstance
    ...
    ${body}=  Set Variable  {"nsdId":"dbe0b036-9fbb-3627-89c4-19a8eeeabda8","nsName":"TEST1 NS","nsDescription": "NS for test1"}
...
ms-nso-id-creation
    ${headers}=  Set Variable    {"Version":"1.0", "Content-Type":"application/json", "Accept":"application/json"}
    ${body}=  Set Variable  {"nsdId":"dbe0b036-9fbb-3627-89c4-19a8eeeabda8","nsName":"TEST2 NS","nsDescription": "NS for test2"}
    POST nsInstance     ${headers}      ${body}
...
POST Instantiate nsInstance
    ...
    Set Headers    {"Version":"1.0", "Content-Type":"application/json", "Accept":"application/json"}
    ${body}=  Set Variable  {"additionalParamsForNs":{"kvs":[{"key":"target-site","value":"SPAIN_5TONIC"}]}, "nsFlavourId":"clone_delay_vnf_flavor"}
